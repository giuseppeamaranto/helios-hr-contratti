...
export const MOCK_PROCESSES: ContractProcess[] = [
  ...
  // ── Test cases per coverage 3 filoni × statuses chiave ──────────────────

  // ─ Filone RECRUITING ─────────────────────────────────────────────────────

  // PROC-2026-007 — Recruiting CoCoCo, in approvazione RS (gate iniziale)
  {
    id: 'PROC-2026-007',
    createdAt: '2026-05-15T09:00:00Z',
    updatedAt: '2026-05-15T09:00:00Z',
    status: 'approvazione-rs',
    entryMode: 'recruiting',
    operationType: 'nuova-assunzione',
    requestedBy: 'Prof. Laura Conti',
    requestedByEmail: 'laura.conti@cmcc.it',
    unitCode: 'IESP', unitName: 'IESP - Istituto per la Previsione del Sistema Terrestre',
    projectCode: 'EU-HORIZON-2024-02', projectName: 'OceanPredict - Atlantic Forecasting',
    costCenter: 'EU-OP02',
    isUrgent: false,
    notes: 'Candidato da Job Call JC-IESP-2025-03 — dati anagrafici parziali da completare',
    contractCategory: 'non-subordinato',
    contractType: 'cococo',
    modType: 'mod09',
    isNewResource: true,
    newResourceName: 'Lorenzo Marchetti',
    newResourceEmail: 'lorenzo.marchetti@cmcc.it',
    fromRecruiting: true,
    recruitingCandidateId: 'REC-2025-001',
    jobCallCode: 'JC-IESP-2025-03', jobCallTitle: 'Ricercatore Modellistica Atmosferica',
    mod09: {
      contractTypeMod09: 'COCOCO', selectionMode: 'JOB_CALL', language: 'Italiano',
      isProroga: false, activityObject: 'Sviluppo modelli atmosferici regionali per area mediterranea',
      deliverables: 'Articoli scientifici, report tecnici, dataset', startDate: '2026-07-01', endDate: '2027-06-30',
      qualifica: 'POST_DOC', grossCompensation: 2700, numRate: 12, paymentSchedule: 'mensile',
      aliquota: 'piena', vatRequired: false, vatNumber: '', engagement: 'Full Time', engagementPercent: 100,
      workLocation: 'Bologna - Viale C. Berti Pichat 6/2', isPNRR: false, project: 'EU-HORIZON-2024-02',
      workPackage: 'WP3', orgUnit: 'CLIVAP', costCenter: 'EU-OP02', allocationProject: '',
      reportTo: 'Prof. Conti', tools: 'HPC, RegCM, Python', notes: '', directorName: 'Prof. Laura Conti',
      directorDivisionName: '', welfare: 0,
    },
    approvals: [
      { id: 'A1', role: 'rs',         name: 'Prof. Laura Conti', status: 'pending' },
    ...
    documents: [
      { id: 'D1', name: 'CV_Marchetti.pdf', type: 'cv', required: true, status: 'caricato' },
    ],
    history: [
      { id: 'H1', timestamp: '2026-05-15T09:00:00Z', action: 'Processo avviato da Recruiting', actor: 'Prof. Laura Conti', actorRole: 'Responsabile Struttura', toStatus: 'approvazione-rs' },
    ],
    mod13Submitted: false, mod138Required: true, mod138Submitted: false,
    mod102Required: true, mod102Submitted: false, mod14Required: false, mod14Submitted: false,
    zucchettiLoaded: false,
    requestedAmount: 32400, isDirezioneScientifica: true,
  },

  // PROC-2026-008 — Recruiting Sub-TD, in verifica HR (HR Admin riceve doc)
  {
    id: 'PROC-2026-008',
    ...
    requestedByEmail: 'carlo.gentile@cmcc.it',
    unitCode: 'ASC', unitName: 'ASC - Advanced Scientific Computing',
    projectCode: 'ASC-CORE-2024', projectName: 'HPC Infrastructure & Operations',
    costCenter: 'CO-AS01', isUrgent: true,
    notes: 'Assunzione TD per progetto HPC',
    contractCategory: 'subordinato', contractType: 'subordinato-td', modType: 'mod10',
    isNewResource: true, newResourceName: 'Giulio De Santis', newResourceEmail: 'giulio.desantis@cmcc.it',
    fromRecruiting: true, recruitingCandidateId: 'REC-2025-004',
    jobCallCode: 'JC-ASC-2025-01', jobCallTitle: 'HPC System Engineer',
    mod10: {
      contractTypeMod10: 'IMP_TD', isRinnovo: false, startDate: '2026-08-01', endDate: '2028-07-31',
      mansione: 'System Engineer HPC', workLocation: 'Lecce - Via Marco Biagi, 5',
      qualifica: 'JR_AS', ccnlLevel: '3', grossSalaryFT: 32000, partTimePercent: 100,
      welfare: 400, fondi: 1200, orgUnit: 'HPCC', costCenter: 'CO-AS01',
      activityDescription: 'Gestione cluster HPC, manutenzione sistemi storage, supporto utenti', insurance: 'OCC',
      isExpat: false, expatCountry: '', directorName: 'Ing. Carlo Gentile', notes: '',
    },
    approvals: [
      { id: 'A1', role: 'rs',         name: 'Ing. Carlo Gentile', status: 'approved', timestamp: '2026-05-11T09:00:00Z' },
      { id: 'A2', role: 'direttore',  name: '—',                  status: 'pending' },
      { id: 'A3', role: 'governance', name: 'CE / CdA',           status: 'pending' },
      { id: 'A4', role: 'gru',        name: 'HR Admin',           status: 'pending' },
      { id: 'A5', role: 'presidente', name: 'Presidente CMCC',    status: 'pending' },
    ...
    documents: [
      { id: 'D1', name: 'CV_DeSantis.pdf', type: 'cv', required: true, status: 'verificato' },
      { id: 'D2', name: 'Documento_Identità.pdf', type: 'documento-identita', required: true, status: 'caricato' },
    ],
    history: [
      { id: 'H1', timestamp: '2026-05-10T10:00:00Z', action: 'Processo avviato da Recruiting', actor: 'Ing. Gentile', actorRole: 'RS', toStatus: 'approvazione-rs' },
      { id: 'H2', timestamp: '2026-05-11T09:00:00Z', action: 'Approvato da Responsabile Struttura', actor: 'Ing. Gentile', actorRole: 'RS', toStatus: 'verifica-gru' },
    ],
    mod13Submitted: false, mod138Required: true, mod138Submitted: false,
    mod102Required: false, mod102Submitted: false, mod14Required: true, mod14Submitted: false,
    zucchettiLoaded: false, requestedAmount: 32000, isDirezioneScientifica: false,
  },

  // PROC-2026-009 — Recruiting Sub-TI, in approvazione Organo CE (Direzione Scientifica)
  {
    id: 'PROC-2026-009',
    createdAt: '2026-05-08T09:00:00Z',
    updatedAt: '2026-05-18T15:00:00Z',
    status: 'approvazione-organo',
    entryMode: 'recruiting',
    operationType: 'nuova-assunzione',
    requestedBy: 'Prof. Andrea Bianchi',
    requestedByEmail: 'andrea.bianchi@cmcc.it',
    unitCode: 'ICR', unitName: 'ICR - Istituto per la Resilienza Climatica',
    projectCode: 'PNRR-2023-ICR-01', projectName: 'RETURN - Multi-Risk Science for Resilience',
    costCenter: 'PN-RE01', isUrgent: false,
    notes: 'Senior Scientist a tempo indeterminato — passaggio CE',
    contractCategory: 'subordinato', contractType: 'subordinato-ti', modType: 'mod10',
    isNewResource: true, newResourceName: 'Amira Ben Salah', newResourceEmail: 'amira.bensalah@cmcc.it',
    fromRecruiting: true, recruitingCandidateId: 'REC-2025-002',
    jobCallCode: 'JC-ICR-2025-07', jobCallTitle: 'Junior Researcher — Coastal Resilience',
    mod10: {
      contractTypeMod10: 'IMP_TI', isRinnovo: false, startDate: '2026-09-01', endDate: '',
      mansione: 'Junior Researcher', workLocation: 'Viterbo - Via Igino Garbini, 51',
      qualifica: 'JR_AS', ccnlLevel: '3', grossSalaryFT: 35000, partTimePercent: 100,
      welfare: 400, fondi: 1500, orgUnit: 'IAFES', costCenter: 'PN-RE01',
      activityDescription: 'Analisi resilienza costiera, modelli erosione', insurance: 'FREQ',
      isExpat: false, expatCountry: '', directorName: 'Prof. Bianchi', notes: '',
    },
    approvals: [
      { id: 'A1', role: 'rs',         name: 'Prof. Bianchi',    status: 'approved', timestamp: '2026-05-09T10:00:00Z' },
      { id: 'A2', role: 'direttore',  name: 'Direzione Esec.',  status: 'approved', timestamp: '2026-05-13T12:00:00Z' },
      { id: 'A3', role: 'governance', name: 'CE',               status: 'pending' },
      { id: 'A4', role: 'gru',        name: 'HR Admin',         status: 'pending' },
      { id: 'A5', role: 'presidente', name: 'Presidente CMCC',  status: 'pending' },
      { id: 'A6', role: 'segreteria', name: 'Segreteria',       status: 'pending' },
      { id: 'A7', role: 'amm',        name: 'Ufficio AMM',      status: 'pending' },
    ...
    documents: [
      { id: 'D1', name: 'CV_BenSalah.pdf', type: 'cv', required: true, status: 'verificato' },
    ],
    history: [
      { id: 'H1', timestamp: '2026-05-08T09:00:00Z', action: 'Processo avviato', actor: 'Prof. Bianchi', actorRole: 'RS', toStatus: 'approvazione-rs' },
      { id: 'H2', timestamp: '2026-05-09T10:00:00Z', action: 'Approvato da Responsabile', actor: 'Prof. Bianchi', actorRole: 'RS', toStatus: 'verifica-gru' },
      { id: 'H3', timestamp: '2026-05-12T11:00:00Z', action: 'Verifica HR Admin completata', actor: 'HR Admin', actorRole: 'HR Admin', toStatus: 'approvazione-dir' },
      { id: 'H4', timestamp: '2026-05-13T12:00:00Z', action: 'Approvato da Direttore Esecutivo', actor: 'Direzione', actorRole: 'Direttore', toStatus: 'approvazione-organo' },
    ],
    mod13Submitted: false, mod138Required: false, mod138Submitted: false,
    mod102Required: false, mod102Submitted: false, mod14Required: true, mod14Submitted: false,
    zucchettiLoaded: false, requestedAmount: 35000, isDirezioneScientifica: true,
  },

  // ─ Filone EXISTING (anagrafica) ──────────────────────────────────────────

  // PROC-2026-010 — Proroga CoCoCo, in redazione
  {
    id: 'PROC-2026-010',
    ...
    entryMode: 'existing',
    operationType: 'proroga',
    requestedBy: 'Prof. Andrea Bianchi', requestedByEmail: 'andrea.bianchi@cmcc.it',
    unitCode: 'ICR', unitName: 'ICR - Istituto per la Resilienza Climatica',
    projectCode: 'EU-HORIZON-2024-01', projectName: 'ClimAdapt - Climate Adaptation Tools',
    costCenter: 'EU-HA01', isUrgent: false,
    notes: 'Proroga annuale CoCoCo per continuità progetto',
    contractCategory: 'non-subordinato', contractType: 'cococo', modType: 'mod09',
    resourceId: 'BALCAR000001', resource: RESOURCES.find(r => r.idSubject === 'BALCAR000001'),
    isNewResource: false, fromRecruiting: false,
    mod09: {
      contractTypeMod09: 'COCOCO', selectionMode: 'JOB_CALL', language: 'Italiano',
      isProroga: true, prorogaContractId: 'CONTR-2024-BAL', activityObject: 'Prosecuzione attività di ricerca su modelli costieri',
      deliverables: 'Report annuale, pubblicazione', startDate: '2026-01-01', endDate: '2026-12-31',
      qualifica: 'POST_DOC', grossCompensation: 2900, numRate: 12, paymentSchedule: 'mensile',
      aliquota: 'piena', vatRequired: false, vatNumber: '', engagement: 'Full Time', engagementPercent: 100,
      workLocation: 'Viterbo - Via Igino Garbini, 51', isPNRR: false, project: 'EU-HORIZON-2024-01',
      workPackage: 'WP4', orgUnit: 'REMHI', costCenter: 'EU-HA01', allocationProject: '',
      reportTo: 'Prof. Bianchi', tools: '', notes: '', directorName: 'Prof. Andrea Bianchi',
      directorDivisionName: '', welfare: 0,
    },
    approvals: [
      { id: 'A1', role: 'rs',         name: 'Prof. Bianchi',    status: 'approved', timestamp: '2026-05-06T09:00:00Z' },
      { id: 'A2', role: 'direttore',  name: 'Direzione Esec.',  status: 'approved', timestamp: '2026-05-10T11:00:00Z' },
      { id: 'A3', role: 'governance', name: 'CE',               status: 'approved', timestamp: '2026-05-15T14:00:00Z' },
      { id: 'A4', role: 'gru',        name: 'HR Admin',         status: 'approved', timestamp: '2026-05-16T10:00:00Z' },
      { id: 'A5', role: 'presidente', name: 'Presidente CMCC',  status: 'pending' },
      { id: 'A6', role: 'segreteria', name: 'Segreteria',       status: 'pending' },
      { id: 'A7', role: 'amm',        name: 'Ufficio AMM',      status: 'pending' },
    ],
    documents: [],
    history: [
      { id: 'H1', timestamp: '2026-05-05T08:00:00Z', action: 'Processo avviato', actor: 'Prof. Bianchi', actorRole: 'RS', toStatus: 'approvazione-rs' },
      { id: 'H2', timestamp: '2026-05-16T10:00:00Z', action: 'Avanzato a Redazione', actor: 'HR Admin', actorRole: 'HR Admin', toStatus: 'redazione' },
    ],
    mod13Submitted: true, mod138Required: false, mod138Submitted: false,
    mod102Required: false, mod102Submitted: false, mod14Required: false, mod14Submitted: false,
    zucchettiLoaded: false, requestedAmount: 34800, isDirezioneScientifica: true,
    contractAction: 'modify-contract',
    contractActionReason: 'Stessa tipologia, continuità di rapporto: modifica del contratto esistente.',
    interruptionDays: 0,
  },

  // PROC-2026-011 — Trasformazione TD→TI, in anteprima (modifiche segnalate)
  {
    id: 'PROC-2026-011',
    ...
    entryMode: 'existing',
    operationType: 'trasformazione',
    requestedBy: 'Prof. Marco Ferretti', requestedByEmail: 'marco.ferretti@cmcc.it',
    unitCode: 'EIEE', unitName: 'EIEE - Istituto Europeo sull\'Economia e l\'Ambiente',
    projectCode: 'PNRR-2023-EIEE-01', projectName: 'GRINS - Growing Resilient Italy',
    costCenter: 'PN-GR01', isUrgent: false,
    notes: 'Trasformazione TD → TI dopo 2 anni di valutazione positiva',
    contractCategory: 'subordinato', contractType: 'subordinato-ti', modType: 'mod10',
    resourceId: 'ADAMAR000001', resource: RESOURCES.find(r => r.idSubject === 'ADAMAR000001'),
    isNewResource: false, fromRecruiting: false,
    mod10: {
      contractTypeMod10: 'IMP_TI', isRinnovo: true, rinnovoType: 'TRASFORMAZIONE',
      startDate: '2026-11-01', endDate: '',
      mansione: 'Scientist', workLocation: 'Bologna - Viale C. Berti Pichat 6/2',
      qualifica: 'SCI', ccnlLevel: '2', grossSalaryFT: 42000, partTimePercent: 100,
      welfare: 400, fondi: 1800, orgUnit: 'ECIP', costCenter: 'PN-GR01',
      activityDescription: 'Continuazione modellistica oceanografica con maggior autonomia', insurance: 'FREQ',
      isExpat: false, expatCountry: '', directorName: 'Prof. Marco Ferretti', notes: '',
    },
    previewStatus: 'changes',
    previewNotes: 'La risorsa ha segnalato modifiche sulla descrizione attività e sul livello CCNL richiesto.',
    approvals: [
      { id: 'A1', role: 'rs',         name: 'Prof. Ferretti',   status: 'approved', timestamp: '2026-04-21T10:00:00Z' },
      { id: 'A2', role: 'direttore',  name: 'Direzione Esec.',  status: 'approved', timestamp: '2026-04-28T11:00:00Z' },
      { id: 'A3', role: 'governance', name: 'CdA',              status: 'approved', timestamp: '2026-05-12T14:00:00Z' },
      { id: 'A4', role: 'gru',        name: 'HR Admin',         status: 'approved', timestamp: '2026-05-15T09:00:00Z' },
      { id: 'A5', role: 'presidente', name: 'Presidente CMCC',  status: 'pending' },
      { id: 'A6', role: 'segreteria', name: 'Segreteria',       status: 'pending' },
      { id: 'A7', role: 'amm',        name: 'Ufficio AMM',      status: 'pending' },
    ],
    documents: [
      { id: 'D1', name: 'Anteprima_contratto.pdf', type: 'contratto', required: true, status: 'caricato' },
    ],
    history: [
      { id: 'H1', timestamp: '2026-04-20T08:00:00Z', action: 'Processo avviato', actor: 'Prof. Ferretti', actorRole: 'RS', toStatus: 'approvazione-rs' },
      { id: 'H2', timestamp: '2026-05-19T10:00:00Z', action: 'Anteprima inviata, modifiche segnalate dalla risorsa', actor: 'HR Admin', actorRole: 'HR Admin', toStatus: 'anteprima' },
    ],
    mod13Submitted: false, mod138Required: false, mod138Submitted: false,
    mod102Required: false, mod102Submitted: false, mod14Required: true, mod14Submitted: false,
    zucchettiLoaded: false, requestedAmount: 42000, isDirezioneScientifica: false,
    contractAction: 'new-contract',
    contractActionReason: 'Cambio tipologia (subordinato-td → subordinato-ti): nuovo contratto.',
    interruptionDays: 0,
  },

  // PROC-2026-012 — Integrazione (variazione monte ore), firma presidente
  {
    id: 'PROC-2026-012',
    ...
    status: 'firma-presidente',
    entryMode: 'existing',
    operationType: 'integrazione',
    requestedBy: 'Prof. Stefano Russo', requestedByEmail: 'stefano.russo@cmcc.it',
    unitCode: 'REMHI', unitName: 'REMHI - Regional Models and geo-Hydrological Impacts',
    projectCode: 'EU-LIFE-2023-01', projectName: 'LIFE CLIMAX - Extreme Events Atlas',
    costCenter: 'EU-LI01', isUrgent: false,
    notes: 'Integrazione fondi progetto LIFE',
    contractCategory: 'non-subordinato', contractType: 'cococo', modType: 'mod09',
    resourceId: 'AMBFED000001', resource: RESOURCES.find(r => r.idSubject === 'AMBFED000001'),
    isNewResource: false, fromRecruiting: false,
    mod09: {
      contractTypeMod09: 'COCOCO', selectionMode: 'AFFILIATO', language: 'Italiano',
      isProroga: false, activityObject: 'Integrazione contratto per attività addizionali su progetto LIFE',
      deliverables: 'Atlas eventi estremi', startDate: '2026-06-01', endDate: '2026-12-31',
      qualifica: 'SR_SCI', grossCompensation: 4500, numRate: 7, paymentSchedule: 'mensile',
      aliquota: 'piena', vatRequired: false, vatNumber: '', engagement: 'Parziale', engagementPercent: 50,
      workLocation: 'Viterbo - Via Igino Garbini, 51', isPNRR: false, project: 'EU-LIFE-2023-01',
      workPackage: 'WP5', orgUnit: 'REMHI', costCenter: 'EU-LI01', allocationProject: '',
      reportTo: 'Prof. Russo', tools: '', notes: '', directorName: 'Prof. Stefano Russo',
      directorDivisionName: '', welfare: 1500,
    },
    approvals: [
      { id: 'A1', role: 'rs',         name: 'Prof. Russo',     status: 'approved', timestamp: '2026-04-16T10:00:00Z' },
      { id: 'A2', role: 'direttore',  name: 'Direzione Esec.', status: 'approved', timestamp: '2026-04-25T11:00:00Z' },
      { id: 'A3', role: 'governance', name: 'CE',              status: 'approved', timestamp: '2026-05-08T14:00:00Z' },
      { id: 'A4', role: 'gru',        name: 'HR Admin',        status: 'approved', timestamp: '2026-05-14T09:00:00Z' },
      { id: 'A5', role: 'presidente', name: 'Presidente CMCC', status: 'pending' },
      { id: 'A6', role: 'segreteria', name: 'Segreteria',      status: 'pending' },
      { id: 'A7', role: 'amm',        name: 'Ufficio AMM',     status: 'pending' },
    ],
    documents: [],
    history: [
      { id: 'H1', timestamp: '2026-04-15T09:00:00Z', action: 'Processo avviato', actor: 'Prof. Russo', actorRole: 'RS', toStatus: 'approvazione-rs' },
      { id: 'H2', timestamp: '2026-05-18T14:00:00Z', action: 'Avanzato a Firma Presidente', actor: 'HR Admin', actorRole: 'HR Admin', toStatus: 'firma-presidente' },
    ],
    mod13Submitted: true, mod138Required: false, mod138Submitted: false,
    mod102Required: true, mod102Submitted: true, mod14Required: false, mod14Submitted: false,
    zucchettiLoaded: false, requestedAmount: 31500, isDirezioneScientifica: true,
    contractAction: 'modify-contract',
    contractActionReason: 'Stessa tipologia, continuità di rapporto: modifica del contratto esistente.',
    interruptionDays: 0,
  },

  // ─ Filone EXTERNAL-MOD09 ─────────────────────────────────────────────────

  // PROC-2026-013 — Occasionale low amount (<1000€) → skip Dir + Organo
  {
    id: 'PROC-2026-013',
    createdAt: '2026-05-12T10:00:00Z',
    updatedAt: '2026-05-19T16:00:00Z',
    status: 'redazione',
    entryMode: 'external-mod09',
    operationType: 'nuova-assunzione',
    requestedBy: 'Prof. Giulia Romano', requestedByEmail: 'giulia.romano@cmcc.it',
    unitCode: 'IAFES', unitName: 'IAFES - Impacts on Agriculture, Forests and Ecosystem Services',
    projectCode: 'CMCC-CORE-IAFES', projectName: 'Institutional Core Activity - IAFES',
    costCenter: 'CO-IA01', isUrgent: true,
    notes: 'Prestazione occasionale, importo basso < 1000 € → fast-track senza Direttore/Organo',
    contractCategory: 'non-subordinato', contractType: 'occasionale', modType: 'mod09',
    isNewResource: true, newResourceName: 'Mario Esposito', newResourceEmail: 'mario.esposito@external.it',
    fromRecruiting: false,
    mod09: {
      contractTypeMod09: 'OCCASIONALE', selectionMode: 'AFFILIATO', language: 'Italiano',
      isProroga: false, activityObject: 'Revisione tecnica documenti progetto IAFES',
      deliverables: 'Report di revisione', startDate: '2026-06-01', endDate: '2026-06-30',
      qualifica: 'SCI', grossCompensation: 800, numRate: 1, paymentSchedule: 'unico',
      aliquota: 'agevolata', vatRequired: false, vatNumber: '', engagement: 'Parziale', engagementPercent: 20,
      workLocation: 'Remoto', isPNRR: false, project: '', workPackage: '', orgUnit: 'IAFES',
      costCenter: 'CO-IA01', allocationProject: '', reportTo: 'Prof. Romano', tools: '',
      notes: 'Prestazione una tantum', directorName: 'Prof. Giulia Romano', directorDivisionName: '', welfare: 0,
    },
    approvals: [
      { id: 'A1', role: 'rs',         name: 'Prof. Romano',     status: 'approved', timestamp: '2026-05-13T09:00:00Z' },
      { id: 'A2', role: 'direttore',  name: '— (skip <1000€)',  status: 'approved', timestamp: '2026-05-13T09:01:00Z', notes: 'Skip per importo < 1000 €' },
      { id: 'A3', role: 'governance', name: '— (skip <1000€)',  status: 'approved', timestamp: '2026-05-13T09:01:00Z', notes: 'Skip per importo < 1000 €' },
      { id: 'A4', role: 'gru',        name: 'HR Admin',         status: 'approved', timestamp: '2026-05-18T11:00:00Z' },
      { id: 'A5', role: 'presidente', name: 'Presidente CMCC',  status: 'pending' },
      { id: 'A6', role: 'segreteria', name: 'Segreteria',       status: 'pending' },
      { id: 'A7', role: 'amm',        name: 'Ufficio AMM',      status: 'pending' },
    ],
    documents: [],
    history: [
      { id: 'H1', timestamp: '2026-05-12T10:00:00Z', action: 'Processo avviato (MOD09 esterno)', actor: 'Prof. Romano', actorRole: 'RS', toStatus: 'approvazione-rs' },
      { id: 'H2', timestamp: '2026-05-18T11:00:00Z', action: 'Verifica HR Admin completata → Redazione (skip Dir/Organo per importo < 1000€)', actor: 'HR Admin', actorRole: 'HR Admin', toStatus: 'redazione' },
    ],
    mod13Submitted: false, mod138Required: false, mod138Submitted: false,
    mod102Required: false, mod102Submitted: false, mod14Required: false, mod14Submitted: false,
    zucchettiLoaded: false, requestedAmount: 800, isDirezioneScientifica: false,
  },

  // PROC-2026-014 — Consulenza IT, in protocollo (riconciliazione possibile)
  {
    id: 'PROC-2026-014',
    ...
    projectCode: 'PNRR-2023-EIEE-01', projectName: 'GRINS - Growing Resilient Italy',
    costCenter: 'PN-GR01', isUrgent: false,
    notes: 'Consulenza specialistica modellistica economica',
    contractCategory: 'non-subordinato', contractType: 'consulenza-it', modType: 'mod09',
    isNewResource: true, newResourceName: 'Dr. Alessandro Bianchi (P.IVA)',
    newResourceEmail: 'alessandro.bianchi@consulenza.it',
    fromRecruiting: false,
    mod09: {
      contractTypeMod09: 'CONSULENZA', selectionMode: 'AFFILIATO', language: 'Italiano',
      isProroga: false, activityObject: 'Consulenza specialistica su modellistica DSGE per impatti climatici',
      deliverables: 'Report metodologico + sessioni di training', startDate: '2026-07-01', endDate: '2026-12-31',
      qualifica: 'SR_AS', grossCompensation: 5000, numRate: 6, paymentSchedule: 'mensile',
      aliquota: 'piena', vatRequired: true, vatNumber: '12345678901', engagement: 'Parziale', engagementPercent: 30,
      workLocation: 'Remoto', isPNRR: true, project: 'PNRR-2023-EIEE-01', workPackage: 'WP2',
      orgUnit: 'ECIP', costCenter: 'PN-GR01', allocationProject: '', reportTo: 'Prof. Ferretti',
      tools: '', notes: 'Consulente esterno con P.IVA italiana', directorName: 'Prof. Marco Ferretti',
      directorDivisionName: '', welfare: 0,
    },
    approvals: [
      { id: 'A1', role: 'rs',         name: 'Prof. Ferretti',   status: 'approved', timestamp: '2026-05-02T10:00:00Z' },
      { id: 'A2', role: 'direttore',  name: 'Direzione Esec.',  status: 'approved', timestamp: '2026-05-06T11:00:00Z' },
      { id: 'A3', role: 'governance', name: 'CE',               status: 'approved', timestamp: '2026-05-12T14:00:00Z' },
      { id: 'A4', role: 'gru',        name: 'HR Admin',         status: 'approved', timestamp: '2026-05-15T09:00:00Z' },
      { id: 'A5', role: 'presidente', name: 'Presidente CMCC',  status: 'approved', timestamp: '2026-05-18T16:00:00Z' },
      { id: 'A6', role: 'segreteria', name: 'Segreteria',       status: 'pending' },
      { id: 'A7', role: 'amm',        name: 'Ufficio AMM',      status: 'pending' },
    ],
    documents: [],
    history: [
      { id: 'H1', timestamp: '2026-05-01T09:00:00Z', action: 'Processo avviato (MOD09 esterno consulenza)', actor: 'Prof. Ferretti', actorRole: 'RS', toStatus: 'approvazione-rs' },
      { id: 'H2', timestamp: '2026-05-19T12:00:00Z', action: 'Avanzato a Protocollo', actor: 'HR Admin', actorRole: 'HR Admin', toStatus: 'protocollo' },
    ],
    mod13Submitted: false, mod138Required: false, mod138Submitted: false,
    mod102Required: false, mod102Submitted: false, mod14Required: false, mod14Submitted: false,
    zucchettiLoaded: false, requestedAmount: 30000, isDirezioneScientifica: true,
  },

  // PROC-2026-015 — Consulenza ES in anagrafica (riconciliazione Zucchetti PENDENTE)
  {
    id: 'PROC-2026-015',
    ...
    projectCode: 'EU-HORIZON-2024-01', projectName: 'ClimAdapt - Climate Adaptation Tools',
    costCenter: 'EU-HA01', isUrgent: false,
    notes: 'Consulenza estera con P.IVA — riconciliazione Zucchetti richiesta',
    contractCategory: 'non-subordinato', contractType: 'consulenza-es', modType: 'mod09',
    isNewResource: true, newResourceName: 'Dr. Heinrich Mueller', newResourceEmail: 'h.mueller@external.de',
    fromRecruiting: false,
    mod09: {
      contractTypeMod09: 'CONS_EST', selectionMode: 'CHIARA_FAMA', language: 'Inglese',
      isProroga: false, activityObject: 'Expert advisor on European climate adaptation policy',
      deliverables: 'Strategic report, policy briefs', startDate: '2026-06-15', endDate: '2026-11-15',
      qualifica: 'PRINCIPAL_SCI', grossCompensation: 8000, numRate: 5, paymentSchedule: 'mensile',
      aliquota: 'piena', vatRequired: true, vatNumber: 'DE123456789', engagement: 'Parziale', engagementPercent: 25,
      workLocation: 'Remoto', isPNRR: false, project: 'EU-HORIZON-2024-01', workPackage: 'WP1',
      orgUnit: 'IAFES', costCenter: 'EU-HA01', allocationProject: '', reportTo: 'Prof. Bianchi',
      tools: '', notes: 'Foreign consultant', directorName: 'Prof. Andrea Bianchi',
      directorDivisionName: '', welfare: 0,
    },
    approvals: [
      { id: 'A1', role: 'rs',         name: 'Prof. Bianchi',    status: 'approved', timestamp: '2026-04-26T09:00:00Z' },
      { id: 'A2', role: 'direttore',  name: 'Direzione Esec.',  status: 'approved', timestamp: '2026-05-01T10:00:00Z' },
      { id: 'A3', role: 'governance', name: 'CE',               status: 'approved', timestamp: '2026-05-08T14:00:00Z' },
      { id: 'A4', role: 'gru',        name: 'HR Admin',         status: 'approved', timestamp: '2026-05-12T09:00:00Z' },
      { id: 'A5', role: 'presidente', name: 'Presidente CMCC',  status: 'approved', timestamp: '2026-05-15T16:00:00Z' },
      { id: 'A6', role: 'segreteria', name: 'Segreteria',       status: 'approved', timestamp: '2026-05-17T10:00:00Z', notes: 'PROT-2026-7821' },
      { id: 'A7', role: 'amm',        name: 'Ufficio AMM',      status: 'pending' },
    ],
    documents: [],
    history: [
      { id: 'H1', timestamp: '2026-04-25T09:00:00Z', action: 'Processo avviato (MOD09 consulenza estera)', actor: 'Prof. Bianchi', actorRole: 'RS', toStatus: 'approvazione-rs' },
      { id: 'H2', timestamp: '2026-05-19T15:00:00Z', action: 'Avanzato ad Anagrafica — riconciliazione Zucchetti richiesta', actor: 'Segreteria', actorRole: 'Segreteria', toStatus: 'anagrafica' },
    ],
    mod13Submitted: false, mod138Required: false, mod138Submitted: false,
    mod102Required: false, mod102Submitted: false, mod14Required: false, mod14Submitted: false,
    zucchettiLoaded: false, zucchettiReconciled: false,
    requestedAmount: 40000, isDirezioneScientifica: true, protocolNumber: 'PROT-2026-7821',
  },

  // PROC-2026-016 — Proroga TD respinta → testa revoca rifiuto
  {
    id: 'PROC-2026-016',
    ...
    entryMode: 'existing',
    operationType: 'proroga',
    requestedBy: 'Prof. Laura Conti', requestedByEmail: 'laura.conti@cmcc.it',
    unitCode: 'IESP', unitName: 'IESP - Istituto per la Previsione del Sistema Terrestre',
    projectCode: 'MUR-2024-IESP-01', projectName: 'PRIN 2023 - Ciclo Idrologico Mediterraneo',
    costCenter: 'MU-PR01', isUrgent: false,
    notes: 'Proroga TD respinta in fase Direttore Esecutivo — testa la revoca',
    contractCategory: 'subordinato', contractType: 'subordinato-td', modType: 'mod10',
    resourceId: 'ACCGAB000001', resource: RESOURCES.find(r => r.idSubject === 'ACCGAB000001'),
    isNewResource: false, fromRecruiting: false,
    mod10: {
      contractTypeMod10: 'IMP_TD', isRinnovo: true, rinnovoType: 'PROROGA_TD',
      startDate: '2026-10-01', endDate: '2027-09-30',
      mansione: 'Junior Scientist', workLocation: 'Lecce - Via Marco Biagi, 5',
      qualifica: 'JR_SCI', ccnlLevel: '3', grossSalaryFT: 30000, partTimePercent: 100,
      welfare: 400, fondi: 1200, orgUnit: 'CLIVAP', costCenter: 'MU-PR01',
      activityDescription: 'Proroga annuale per continuità modellazione', insurance: 'OCC',
      isExpat: false, expatCountry: '', directorName: 'Prof. Laura Conti', notes: '',
    },
    approvals: [
      { id: 'A1', role: 'rs',         name: 'Prof. Conti',      status: 'approved', timestamp: '2026-05-11T10:00:00Z' },
      { id: 'A2', role: 'direttore',  name: 'Direzione Esec.',  status: 'rejected', timestamp: '2026-05-18T17:00:00Z', notes: 'Performance non sufficiente per proroga' },
      { id: 'A3', role: 'governance', name: 'CE',               status: 'pending' },
      { id: 'A4', role: 'gru',        name: 'HR Admin',         status: 'pending' },
      { id: 'A5', role: 'presidente', name: 'Presidente CMCC',  status: 'pending' },
      { id: 'A6', role: 'segreteria', name: 'Segreteria',       status: 'pending' },
    ...
    documents: [],
    history: [
      { id: 'H1', timestamp: '2026-05-10T09:00:00Z', action: 'Processo avviato', actor: 'Prof. Conti', actorRole: 'RS', toStatus: 'approvazione-rs' },
      { id: 'H2', timestamp: '2026-05-11T10:00:00Z', action: 'Approvato da Responsabile', actor: 'Prof. Conti', actorRole: 'RS', toStatus: 'verifica-gru' },
      { id: 'H3', timestamp: '2026-05-14T11:00:00Z', action: 'Verifica HR completata', actor: 'HR Admin', actorRole: 'HR Admin', toStatus: 'approvazione-dir' },
      { id: 'H4', timestamp: '2026-05-18T17:00:00Z', action: 'Respinto dal Direttore Esecutivo', actor: 'Direzione', actorRole: 'Direttore', notes: 'Performance non sufficiente', toStatus: 'respinto' },
    ],
    mod13Submitted: false, mod138Required: true, mod138Submitted: false,
    mod102Required: false, mod102Submitted: false, mod14Required: true, mod14Submitted: false,
    zucchettiLoaded: false, requestedAmount: 30000, isDirezioneScientifica: false,
    contractAction: 'modify-contract',
    contractActionReason: 'Stessa tipologia, continuità di rapporto: modifica del contratto esistente.',
    interruptionDays: 0,
  },

  // PROC-2026-017 — Borsa di Studio MOD09 in monitoraggio (post-firma)
  {
    id: 'PROC-2026-017',
    ...
    unitCode: 'IAFES', unitName: 'IAFES - Impacts on Agriculture, Forests and Ecosystem Services',
    projectCode: 'CMCC-CORE-IAFES', projectName: 'Institutional Core Activity - IAFES',
    costCenter: 'CO-IA01', isUrgent: false,
    notes: 'Borsa di studio annuale per dottorando',
    contractCategory: 'non-subordinato', contractType: 'borsa-studio', modType: 'mod09',
    isNewResource: true, newResourceName: 'Sara Bianchi', newResourceEmail: 'sara.bianchi@phd.cmcc.it',
    fromRecruiting: false,
    mod09: {
      contractTypeMod09: 'COCOCO', selectionMode: 'JOB_CALL', language: 'Italiano',
      isProroga: false, activityObject: 'Attività di ricerca su agricoltura sostenibile',
      deliverables: 'Tesi di dottorato, pubblicazioni', startDate: '2026-04-01', endDate: '2027-03-31',
      qualifica: 'POST_DEGREE', grossCompensation: 1600, numRate: 12, paymentSchedule: 'mensile',
      aliquota: 'agevolata', vatRequired: false, vatNumber: '', engagement: 'Full Time', engagementPercent: 100,
      workLocation: 'Sassari - Via De Nicola, 9', isPNRR: false, project: 'CMCC-CORE-IAFES',
      workPackage: '', orgUnit: 'IAFES', costCenter: 'CO-IA01', allocationProject: '',
      reportTo: 'Prof. Romano', tools: '', notes: 'Borsa di studio dottorato', directorName: 'Prof. Giulia Romano',
      directorDivisionName: '', welfare: 0,
    },
    approvals: [
      { id: 'A1', role: 'rs',         name: 'Prof. Romano',     status: 'approved', timestamp: '2026-03-02T10:00:00Z' },
      { id: 'A2', role: 'direttore',  name: 'Direzione Esec.',  status: 'approved', timestamp: '2026-03-08T11:00:00Z' },
      { id: 'A3', role: 'governance', name: 'CE',               status: 'approved', timestamp: '2026-03-15T14:00:00Z' },
      { id: 'A4', role: 'gru',        name: 'HR Admin',         status: 'approved', timestamp: '2026-03-20T09:00:00Z' },
      { id: 'A5', role: 'presidente', name: 'Presidente CMCC',  status: 'approved', timestamp: '2026-03-25T16:00:00Z' },
      { id: 'A6', role: 'segreteria', name: 'Segreteria',       status: 'approved', timestamp: '2026-03-27T10:00:00Z' },
      { id: 'A7', role: 'amm',        name: 'Ufficio AMM',      status: 'approved', timestamp: '2026-03-30T11:00:00Z' },
    ],
    documents: [],
    history: [
      { id: 'H1', timestamp: '2026-03-01T09:00:00Z', action: 'Processo avviato (borsa di studio)', actor: 'Prof. Romano', actorRole: 'RS', toStatus: 'approvazione-rs' },
      { id: 'H2', timestamp: '2026-04-05T09:00:00Z', action: 'Anagrafica completata + riconciliazione Zucchetti', actor: 'AMM', actorRole: 'AMM', toStatus: 'monitoraggio' },
    ],
    mod13Submitted: true, mod138Required: false, mod138Submitted: false,
    mod102Required: false, mod102Submitted: false, mod14Required: false, mod14Submitted: false,
    zucchettiLoaded: true, zucchettiId: 'ZUC-345678', zucchettiReconciled: true,
    requestedAmount: 19200, isDirezioneScientifica: true,
    monitoringEndDate: '2027-03-31', protocolNumber: 'PROT-2026-7654',
  },
];
